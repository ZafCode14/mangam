...
function CaveFront({ vendor }: Props) {
  ...
  return (
    <div className="h-full w-full absolute top-0 right-0">
      ...
      {/** Position 1 */}
      <div
        className={`${commonStyle} bottom-[29vw] left-[11vw] z-20`}
        onClick={() => {
          setProductID(id0);
          setShowProduct(true);
        }}
      ...
      {/** Position 2 */}
      <div
        className={`${commonStyle} bottom-[19.3vw] left-[11vw] z-20`}
        onClick={() => {
          setProductID(id1);
          setShowProduct(true);
        }}
      ...
      {/** Position 3 */}
      <div
        className={`${commonStyle} bottom-[9.5vw] left-[11vw] z-20`}
        onClick={() => {
          setProductID(id2);
          setShowProduct(true);
        }}
      ...
      {/** Position 4 */}
      <div
        className={`${commonStyle} bottom-[29vw] right-[10vw] z-20`}
        onClick={() => {
          setProductID(id3);
          setShowProduct(true);
        }}
      ...
      {/** Position 5 */}
      <div
        className={`${commonStyle} bottom-[19.3vw] right-[10vw] z-20`}
        onClick={() => {
          setProductID(id4);
          setShowProduct(true);
        }}
      ...
      {/** Position 6 */}
      <div
        className={`${commonStyle} bottom-[9.4vw] right-[10vw] z-20`}
        onClick={() => {
          setProductID(id5);
          setShowProduct(true);
        }}
