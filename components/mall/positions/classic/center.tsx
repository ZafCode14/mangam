...
function ClassicCenter({ vendor }: Props) {
  ...
  const id0 = vendor.vendor.spots[`${shopStyle}3.jpg`]?.[0]?.productID;
  const id1 = vendor.vendor.spots[`${shopStyle}3.jpg`]?.[1]?.productID;
  const id2 = vendor.vendor.spots[`${shopStyle}3.jpg`]?.[2]?.productID;
  const id3 = vendor.vendor.spots[`${shopStyle}3.jpg`]?.[3]?.productID;
  const id4 = vendor.vendor.spots[`${shopStyle}3.jpg`]?.[4]?.productID;
  const id5 = vendor.vendor.spots[`${shopStyle}3.jpg`]?.[5]?.productID;
