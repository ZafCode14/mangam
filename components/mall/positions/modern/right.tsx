...
function ModernRight({ vendor }: Props) {
  ...
  const id12 = vendor.vendor.spots[`${shopStyle}right.jpg`]?.[12]?.productID;
  const id13 = vendor.vendor.spots[`${shopStyle}right.jpg`]?.[13]?.productID;
  const id14 = vendor.vendor.spots[`${shopStyle}right.jpg`]?.[14]?.productID;
  const id15 = vendor.vendor.spots[`${shopStyle}right.jpg`]?.[15]?.productID;
  const id16 = vendor.vendor.spots[`${shopStyle}right.jpg`]?.[16]?.productID;
  const id17 = vendor.vendor.spots[`${shopStyle}right.jpg`]?.[17]?.productID;
  ...
  return (
    <div className="h-full w-full absolute top-0 right-0">
      ...
      {/** Front Right Set */}
      {/** Position 1 */}
      <div className={`${commonStyle} bottom-[12vw] left-[18vw] w-[10vw] h-[12vw] z-20`} onClick={() => { setProductID(id0); setShowProduct(true); }}>
        {image0 && (
          <Image
            src={image0}
            alt="item"
      ...
      {/** Position 2 */}
      <div className={`${commonStyle} bottom-[14vw] left-[28.5vw] w-[8vw] h-[10vw] z-20`} onClick={() => { setProductID(id1); setShowProduct(true); }}>
        {image1 && (
          <Image
            src={image1}
            alt="item"
