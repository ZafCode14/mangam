...
function IndustrialEnd({ vendor }: Props) {
  ...
  return (
    <div className="h-full w-full absolute top-0 right-0">
      ...
      {/** Position 1 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[10.5vw] z-20`}
        onClick={() => {
          setProductID(id0);
          setShowProduct(true);
        }}
      ...
      {/** Position 2 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[20vw] z-20`}
        onClick={() => {
          setProductID(id1);
          setShowProduct(true);
        }}
      ...
      {/** Position 3 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[31.5vw] z-20`}
        onClick={() => {
          setProductID(id2);
          setShowProduct(true);
        }}
      ...
      {/** Position 4 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[41.5vw] z-20`}
        onClick={() => {
          setProductID(id3);
          setShowProduct(true);
        }}
      ...
      {/** Position 5 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[55.5vw] z-20`}
        onClick={() => {
          setProductID(id4);
          setShowProduct(true);
        }}
      ...
      {/** Position 6 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[65.5vw] z-20`}
        onClick={() => {
          setProductID(id5);
          setShowProduct(true);
        }}
      ...
      {/** Position 7 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[75vw] z-20`}
        onClick={() => {
          setProductID(id6);
          setShowProduct(true);
        }}
      ...
      {/** Position 8 */}
      <div
        className={`${commonStyle} bottom-[18vw] left-[85vw] z-20`}
        onClick={() => {
          setProductID(id7);
          setShowProduct(true);
        }}
